...
// not-found NÃO recebe `params` (limitação do Next) e ler `headers()` aqui
// forçaria render dinâmico — o que estamos justamente eliminando. Então o 404
// é ESTÁTICO com copy EN. O `<html lang>` continua correto (vem do layout, que
// tem o locale). Débito conhecido: 404 não localiza a copy nas 25 línguas
// não-EN nem preserva o país no "Browse all" (era via x-pathname). 404 é
// noindex/low-value; localizar via client component (usePathname) fica pra depois.
