...
// Cookie preferences hub — parte interativa (client). O JSON-LD canônico
// passou pro `page.tsx` server component (round 25 Track CC) pra poder
// carregar o `nonce` da CSP — `<script>` inline sem nonce é bloqueado pela
// nova CSP `'nonce-... strict-dynamic'`.
//
